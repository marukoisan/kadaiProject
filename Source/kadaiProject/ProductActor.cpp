...
AProductActor::AProductActor()
{
	...
	CollisionBox->OnComponentBeginOverlap.AddDynamic(this, &AProductActor::OnOverlapBegin);//当たった瞬間のオーバーラップ
...
void AProductActor::OnOverlapBegin(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	...
	if (Darts != nullptr)
	{
		...
		{
			ProjectCharacter->ProductSetScore(variable,element);
